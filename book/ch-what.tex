...
\figref{ch-what/hidden_1} shows how to create a simple file that
...
``black.'' (The text background control is the box that looks like this:\includegraphics[height=1.5ex]{ch-what/highlight_control}).
