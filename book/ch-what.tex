...
The file |hidden.rtf| is seven lines long and has just 297 bytes; the contents appear in
\lstref{hidden.rtf}. The file |hidden.pdf|, in contrast, is 8304 bytes
...
\sgraphic{ch-what/hidden-more}{The file |hidden.pdf| viewed with the
  program \emph{less}.}
