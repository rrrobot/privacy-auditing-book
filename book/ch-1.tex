...
inadvertently left in a digital document. Specifically, this book is about
...
information networks, or stored on digital systems.

Sometimes it seems that computers sometimes have a hard time keeping secrets.  Consider these two cases:
...
$10^9=1,000,000,000$ bytes. The ``B'' multiplier is short for
``billion,'' which is a US billion. 
...
from the way that these systems are addressed. Memory is  addressed
