...
\texttt{vim-common}\footnote{We're not sure why xxd is part of
  vim-common. If you didn't know this, yo ucould find it out with the
  command \texttt{yum whatprovides}:
\begin{code}
